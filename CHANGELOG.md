...
- The extraction method now resets from `AI_GENERATED(_WITH_MANUAL_REVIEW)` to `MANUAL` when the label of a thing is updated.
  (See [!1526](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1526))
...
## [0.101.1] - 2026-08-13
### Fixed
- Fixed `published` parameter typing in autogenerated api client libraries for paper listing endpoint.
- Fixed deserialization issues of smart review- and literature list section requests for generated api client libraries.
...
## [0.98.6] - 2026-07-20
### Fixed
- Fixed xsd:time validation wrongfully allowing for optional hour and minute fields and not accepting 24:00:00.
  (See [!1512](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1512))
- Fixed schema generation of identifier maps for autogenerated api client libraries.
  (See [#698](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/work_items/698))
- Fixed `objects` field typing of rosetta stone statement request and response classes for autogenerated api client libraries.
  (See [#699](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/work_items/699))
- Fixed `id` field typing of `UpdateTableCellRequest` schema for autogenerated api client libraries.
  (See [#700](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/work_items/700))
...
## [0.98.4] - 2026-06-11
### Fixed
- Fixed a regression in the Spring Batch 6 update that caused in-memory repository usage instead of jdbc.

## [0.98.3] - 2026-06-02
### Fixed
- Fixed multipart requests not working correctly in generated API clients.
  (See [!1507](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1507))

## [0.98.2] - 2026-06-01
### Fixed
- Fixed timeline endpoint not parsing some timestamps correctly, resulting in a status 500.

## [0.98.1] - 2026-05-29
### Fixed
- Fixed CSV import validation.
  (See [!1506](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1506))
- Fixed mermaid diagrams in API documentation.

## [0.98.0] - 2026-05-28
### Added
- Added extraction method values for autogenerated content.
  (See [!1496](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1496))
### Changed
- Updated to Cypher 25.
  (See [!1488](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1488))
- Paper snapshots are now stored in the backend database.
  (See [!1488](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1488))
- Updated documentation.
  (See [!1490](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1490))
- Comparison table paths are now trimmed more aggressively.
  (See [!1495](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1495))
- Relaxed BibTeX parsing for Smart Review JATS export.
  (See [!1498](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1498))
### Fixed
- Fixed unstable results sorting for graph queries.
  (See [!1492](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1492))
- Fixed some array items not being marked as nullable in generated API clients.
  (See [!1485](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1485))
- Fixed comparison and table endpoints for generated API clients.
  (See [!1493](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1493))
### Removed
- Removed R API client library generation.
  (See [!1486](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1486))
### Breaking
- Migrated to OpenAPI 3.1.
  (See [!1484](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1484))

## [0.97.1] - 2026-04-21
### Fixed
- Fixed navigation header links in API documentation.

## [0.97.0] - 2026-04-21
### Added
- Added a new endpoint for creating template instances.
  (See [!1472](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1472))
- The count of distinct sources featuring a comparison path is now returned when fetching available path.
  (See [!1471](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1471))
- Added helper classes `OAuthConfiguration` and `Hosts` to autogenerated OpenAPI python client.
  (See [!1471](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1471))
### Changed
- The comparison table endpoints now return formatted labels instead of the actual resource label, if available.
  (See [!1474](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1474))
- The exception types `orkg:problem:resource_already_exists`, `orkg:problem:class_already_exists`, `orkg:problem:predicate_already_exists` and `orkg:problem:literal_already_exists` were replaced by `orkg:problem:thing_already_exists`.
  (See [!1475](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1475))
- Selected paths of comparison tables are now initialized on comparison creation. A given path or one of it's children must have a value from at least two distinct sources to be selected.
  (See [!1469](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1469),
       [!1480](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1480))
- Replaced Acsiidoctor documentation with Antora.
  (See [!1423](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1423))
### Fixed
- Fixed identifier parsing for published smart review and literature list content-type endpoints.
  (See [!1473](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1473))
- Fixed thing id existence checks not considering other thing types.
  (See [!1475](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1475))
### Breaking
- The REST-API now requires Java 25.
  (See [!1441](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1441))
- Updated to Neo4j 2026.03.
  (See [!1467](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1467))
...
[0.98.1]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.98.1
[0.98.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.98.0
[0.97.1]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.97.1
[0.97.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.97.0
