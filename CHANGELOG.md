...
## [0.91.3] - 2026-01-16
### Fixed
- Reverted a change that prevented the editing of closed templates.

## [0.91.2] - 2026-01-16
### Fixed
- Fixed several typing issues in the generated OpenAPI spec and its derivative client libraries.
- Fixed wildcard query parameters not working correctly for client libraries.

## [0.91.1] - 2026-01-14
### Fixed
- Fixed doc snippet name.

## [0.91.0] - 2026-01-14
### Added
- Added new research problem endpoints.
  (See: [!1412](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1412))
- Added new author statistics endpoints.
  (See: [!1413](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1413))
### Changes
- Updated to Spring Boot 3.5.8.
  (See: [!1417](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1417))
- Updated to Gradle 8.14.3.
- Updated authentication documentation.
  (See: [!1411](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1411))
### Fixed
- Stabilized OpenAPI spec generation and their derivative clients.
  (See: [!1409](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1409))
- Fixed boolean typing of 'exact' query parameters.
  (See: [!1418](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1418))
- Added missing integration test results to OpenAPI spec generator.
  (See: [!1414](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1414))
- Added missing type hints to OpenAPI spec generating tests.
- Added a missing check to prevent the creation of templates for rosetta stone statement classes.
  (See: [!1416](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1416))
- Fixed naming of widget api methods for autogenerated client libraries.

## [0.90.0] - 2025-12-04
### Added
- Added label property to rosetta stone statements.
  (See: [!1379](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1379))
- Added an endpoint for fetching the OpenAPI specification of the API.
  (See: [!1406](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1406))
- Added typescript and python client generation based on an autogenerated OpenAPI specification.
  (See: [!1377](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1402),
  [!1371](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1391),
  [!1372](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1390),
  [!1375](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1388),
  [!1376](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1385),
  [!1380](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1387),
  [!1381](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1386),
  [!1382](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1384),
  [!1383](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1383),
  [!1384](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1382),
  [!1386](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1381),
  [!1387](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1380),
  [!1385](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1376),
  [!1388](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1375),
  [!1390](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1372),
  [!1391](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1371),
  [!1402](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1377))
- Added possible error types for each endpoint to the AsciiDoc documentation.
  (See: [!1407](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1407))
- Added an endpoint for deleting papers.
  (See: [!1353](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1353))
- Added new endpoints for fetching and listing research fields.
  (See: [!1367](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1367))
- Added new endpoints for listing contributor statistics.
  (See: [!1370](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1370))
- Rosetta stone statement type classes are now automatically assigned to be a subclass of orkgc:RosettaStoneStatement.
  (See: [!1408](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1408))

### Changed
- The index of missing or malformed array values is now correctly reported in error responses.
  (See: [!1395](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1395))
- Updated to Keycloak admin-client 26.0.7.
  (See: [!1378](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1378))
- It is now possible to pass `null` data when updating a single table row.
  (See: [!1393](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1393))
- Migrated to SHA256 hash algorithm for gravatar ids.
  (See: [!1362](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1362))

### Fixed
- Fixed several minor errors in the AsciiDoc documentation.
- Fixed several RDF content-types not working for vocab endpoints (`application/xml`, `text/xml`, text/rdf+n3`, `application/ld+json`, `application/x-trig`, `text/x-nquads`, `text/nquads`, `application/x-turtle`).
  (See: [!1383](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1383))
- Fixed the image, url and description not being validated when creating or updating a comparison related figures or resources.
  (See: [!1398](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1398))
- It is no longer possible to update properties of closed templates when using content-type endpoints.
  (See: [!1399](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1399))
- Fixed author_name filter not working for the generic content-type endpoint.
- Updating a rosetta stone statement resource via the resources endpoint now throws an exception instead of silently discarding the update request.
  (See: [!1373](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1373))
- Fixed status 500 when passing invalid parameter values to the metrics endpoint.
  (See: [!1374](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1374))

### Removed
- Removed outdated user details documentation.
  (See: [!1385](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1385))
- Removed outdated visibility filter documentation.
  (See: [!1389](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1389))

### Breaking
- The `application/json` content-type is no longer accepted on all vocab endpoints. Use `application/ld+json` instead.
  (See: [!1383](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1383))
- The request body of the endpoint for deleting contributor identifiers has been replaced with equivalent query parameters.
  (See: [!1400](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1400))
- The endpoint for fetching classes by URI was merged with the endpoint for fetching classes.
  (See: [!1401](https://gitlab.com/TIBHannover/orkg/orkg-backend/-/merge_requests/1401))

## [0.89.3] - 2025-10-13
### Fixed
- Reverted change in comparison creation and update constraints.

## [0.89.2] - 2025-10-09
### Fixed
- Made rosetta stone statement label migration more robust.

## [0.89.1] - 2025-10-09
### Fixed
- Disabled rosetta stone statement migration.
...
[unreleased]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/compare/0.91.4...master
[0.91.4]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.91.4
[0.91.3]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.91.3
[0.91.2]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.91.2
[0.91.1]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.91.1
[0.91.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.91.0
[0.90.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.90.0
[0.89.3]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.89.3
[0.89.2]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.89.2
[0.89.1]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.89.1
[0.89.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.89.0
[0.88.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.88.0
[0.87.0]: https://gitlab.com/TIBHannover/orkg/orkg-backend/-/tags/0.87.0
