...
extension you have to create an index first and then simply
import the data directly from the OWL file:

  CREATE INDEX ON :Resource(uri)
  CALL semantics.importRDF("file:///data/SemSur_3.owl","RDF/XML", { shortenUrls: false })
