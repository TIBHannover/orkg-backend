...
internal val VALID_GOOGLE_SCHOLAR_ID_REGEX = Regex("""^[-_0-9A-Za-z]{12}$""")
internal val VALID_GOOGLE_SCHOLAR_ID_URI_REGEX = Regex("""^https?://scholar\.google\.[a-z.]+/citations\?user=([-_0-9A-Za-z]{12})""")
