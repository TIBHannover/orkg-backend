...
internal val VALID_RESEARCHER_ID_REGEX = Regex("""^[A-Z]{1,3}-\d{4}-(?:19|20)\d\d$""")
internal val VALID_RESEARCHER_ID_URI_REGEX = Regex("""^https?://www\.researcherid\.com/rid/([A-Z]{1,3}-\d{4}-(?:19|20)\d\d)$""")
