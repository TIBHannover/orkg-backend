            ...
            .andDocument {
                ...
                requestFields<CreateComparisonRequest>(
                    ...
                    *applyPathPrefix("search_protocol.", comparisonSearchProtocolFields()).toTypedArray(),
                    ...
                    fieldWithPath("is_anonymized").description("Whether the comparison should be displayed as anonymous."),
        ...
        documentedPutRequestTo("/api/comparisons/{id}", id)
            ...
            .andDocument {
                ...
                requestFields<UpdateComparisonRequest>(
                    ...
                    fieldWithPath("sdgs").description("The set of ids of sustainable development goals the comparison will be assigned to. (optional)").arrayItemsType("String").constraints(thingIdConstraint).optional(),
                    fieldWithPath("sources").description("The list of data sources of the comparison. (optional)").optional(),
                    fieldWithPath("sources[].id").description("The ID of the data source."),
                    fieldWithPath("sources[].type").description("The type of the data source. Either of $allowedComparisonDataSourceTypeValues"),
                    fieldWithPath("search_protocol").description("The search protocol used to find the literature featured in the comparison. (optional)").optional(),
                    *applyPathPrefix("search_protocol.", comparisonSearchProtocolFields()).toTypedArray(),
                    ...
                    fieldWithPath("is_anonymized").description("Whether the comparison should be displayed as anonymous. (optional)").optional(),
