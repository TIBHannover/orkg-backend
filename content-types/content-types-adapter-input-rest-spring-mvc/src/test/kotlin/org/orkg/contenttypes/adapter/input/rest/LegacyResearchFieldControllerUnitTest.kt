...
@ContextConfiguration(classes = [LegacyResearchFieldController::class, ContentTypeControllerUnitTestConfiguration::class])
@WebMvcTest(controllers = [LegacyResearchFieldController::class])
internal class LegacyResearchFieldControllerUnitTest : MockMvcBaseTest("research-fields") {
    @MockkBean
    private lateinit var useCases: LegacyResearchFieldUseCases
