        ...
        documentedGetRequestTo("/api/papers")
            ...
            .andDocument {
                ...
                pagedQueryParameters(
                    ...
                    parameterWithName("verified").description("Filter for the verified flag of the paper. (optional)").type(ParameterType.BOOLEAN).optional(),
                    ...
                    parameterWithName("published").description("Filter for the publication status of the paper. (optional)").type(ParameterType.BOOLEAN).optional(),
                )
