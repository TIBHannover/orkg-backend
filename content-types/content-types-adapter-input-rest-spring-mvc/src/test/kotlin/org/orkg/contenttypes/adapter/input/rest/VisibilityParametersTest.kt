...
@ContextConfiguration(classes = [VisibilityParametersTest.VisibilityRequestParametersDummyController::class])
@WebMvcTest(controllers = [VisibilityParametersTest.VisibilityRequestParametersDummyController::class])
internal class VisibilityParametersTest : RestDocsTest("visibility") {
    @Test
