...
fun paperResponseFields() = listOf(
    ...
    *applyPathPrefix("mentionings[].", resourceReferenceResponseFields()).toTypedArray(),
    ...
    fieldWithPath("published").description("Whether the paper has published versions through the ORKG or not."),
...
fun versionInfoResponseFields(path: String = "versions") = listOf(
    ...
    fieldWithPath("$path.published[].changelog").type("String").description("The changelog of the published version. (optional)").optional(),
)
