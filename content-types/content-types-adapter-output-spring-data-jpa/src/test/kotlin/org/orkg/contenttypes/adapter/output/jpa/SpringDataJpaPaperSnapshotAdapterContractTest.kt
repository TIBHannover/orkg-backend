...
import org.orkg.contenttypes.output.testing.fixtures.PaperSnapshotRepositoryContracts
...
@ContextConfiguration(
    classes = [
        SpringDataJpaPaperSnapshotAdapter::class,
...
internal class SpringDataJpaPaperSnapshotAdapterContractTest : PaperSnapshotRepositoryContracts {
    @Autowired
    private lateinit var adapter: SpringDataJpaPaperSnapshotAdapter

    override val repository: PaperSnapshotRepository
        get() = adapter
