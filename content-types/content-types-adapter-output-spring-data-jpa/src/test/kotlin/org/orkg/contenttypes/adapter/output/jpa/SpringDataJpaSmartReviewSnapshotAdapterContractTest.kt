...
import org.orkg.contenttypes.output.testing.fixtures.SmartReviewSnapshotRepositoryContracts
...
@ContextConfiguration(
    classes = [
        SpringDataJpaSmartReviewSnapshotAdapter::class,
...
internal class SpringDataJpaSmartReviewSnapshotAdapterContractTest : SmartReviewSnapshotRepositoryContracts {
    @Autowired
    private lateinit var adapter: SpringDataJpaSmartReviewSnapshotAdapter

    override val repository: SmartReviewSnapshotRepository
        get() = adapter
