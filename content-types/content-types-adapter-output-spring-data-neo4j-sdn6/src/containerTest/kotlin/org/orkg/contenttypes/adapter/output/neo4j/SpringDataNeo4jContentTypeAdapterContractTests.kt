...
import org.orkg.contenttypes.output.testing.fixtures.contentTypeRepositoryContract
...
@ContextConfiguration(
    classes = [
        SpringDataNeo4jContentTypeAdapter::class,
...
internal class SpringDataNeo4jContentTypeAdapterContractTests(
    @Autowired private val springDataNeo4jContentTypeAdapter: ContentTypeRepository,
