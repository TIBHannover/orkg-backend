...
interface Neo4jResearchFieldRepository :
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY_IS_LISTED $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD_WITH_ID $WITH_DISTINCT_NODE $WHERE_VISIBILITY $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
