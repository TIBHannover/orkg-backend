...
import org.orkg.contenttypes.output.testing.fixtures.comparisonAuxiliaryContract
...
@Neo4jContainerUnitTest(
    classes = [
        ...
        SpringDataNeo4jComparisonAuxiliaryAdapter::class,
        GraphNeo4jConfiguration::class,
        ContentTypesNeo4jConfiguration::class,
        CypherQueryBuilderConfiguration::class,
    ],
)
internal class SpringDataNeo4jComparisonAuxiliaryAdapterContractTest(
    ...
    @Autowired private val springDataNeo4jComparisonPathAdapter: ComparisonAuxiliaryRepository,
) : DescribeSpec({
        include(
