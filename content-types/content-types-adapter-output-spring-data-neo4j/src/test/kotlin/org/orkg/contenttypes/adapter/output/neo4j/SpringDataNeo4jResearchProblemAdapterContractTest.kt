...
import org.orkg.contenttypes.output.testing.fixtures.researchProblemRepositoryContract
...
@Neo4jContainerUnitTest(
    classes = [
        SpringDataNeo4jResearchProblemAdapter::class,
    ...
    @param:Autowired private val springDataNeo4jPredicateAdapter: PredicateRepository,
        ...
        include(
            researchProblemRepositoryContract(
                springDataNeo4jResearchProblemAdapter,
