...
fun createTemplate() = Template(
    ...
    targetClass = ClassReference(
        ...
        label = "Target Class",
        uri = IRI.create("https://orkg.org/class/targetClass"),
    ),
...
fun createStringLiteralTemplateProperty() = StringLiteralTemplateProperty(
    ...
    datatype = ClassReference(Classes.string, "string literal property class label", IRI.create(Literals.XSD.STRING.uri)),
)
...
fun createNumberLiteralTemplateProperty() = NumberLiteralTemplateProperty(
    ...
    datatype = ClassReference(Classes.integer, "number literal property class label", IRI.create(Literals.XSD.INT.uri)),
)
...
fun createFloatLiteralTemplateProperty() = NumberLiteralTemplateProperty(
    ...
    datatype = ClassReference(Classes.float, "float literal property class label", IRI.create(Literals.XSD.FLOAT.uri)),
)
...
fun createDecimalLiteralTemplateProperty(): NumberLiteralTemplateProperty = NumberLiteralTemplateProperty(
    ...
    datatype = ClassReference(Classes.decimal, "decimal literal property class label", IRI.create(Literals.XSD.DECIMAL.uri)),
)
...
fun createOtherLiteralTemplateProperty() = OtherLiteralTemplateProperty(
    ...
    datatype = ClassReference(Classes.integer, "literal property class label", IRI.create(Literals.XSD.INT.uri)),
)
