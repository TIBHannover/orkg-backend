    ...
    override fun findAllEntitiesBasedOnClassByProblem(
        ...
        if (classes.isNotEmpty()) {
            when (visibilityFilter) {
                ...
                VisibilityFilter.UNLISTED -> findAllEntitiesBasedOnClassByProblemAndVisibility(classes, problemId,
                    Visibility.UNLISTED, pageable, resultList, totals)
                VisibilityFilter.FEATURED -> findAllEntitiesBasedOnClassByProblemAndVisibility(classes, problemId,
                    Visibility.FEATURED, pageable, resultList, totals)
                VisibilityFilter.NON_FEATURED -> findAllEntitiesBasedOnClassByProblemAndVisibility(classes, problemId,
                    Visibility.DEFAULT, pageable, resultList, totals)
                VisibilityFilter.DELETED -> findAllEntitiesBasedOnClassByProblemAndVisibility(classes, problemId,
                    Visibility.DELETED, pageable, resultList, totals)
            }
