...
abstract class IdentifierValidator(
    ...
    internal fun validate(identifiers: Map<String, String>, `class`: ThingId, subjectId: ThingId?, exceptionFactory: (String) -> Throwable) {
        Identifiers.paper.parse(identifiers).forEach { (identifier, value) ->
