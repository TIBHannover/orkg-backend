...
internal class TemplateInstancePropertyValueUpdateValidatorUnitTest : MockkBaseTest {
    ...
    private val templateInstancePropertyValueUpdateValidator = TemplateInstancePropertyValueUpdateValidator(
    ...
    fun `Given a template instance update command, when validating its properties, it returns success`() {
        ...
        val result = templateInstancePropertyValueUpdateValidator(command, state)
    ...
    fun `Given a template instance update command, when provided property is not defined by template, it throws an exception`() {
        ...
        shouldThrow<UnknownTemplateProperties> { templateInstancePropertyValueUpdateValidator(command, state) }.asClue {
