...
internal inline fun <reified T : Any> ExecutionContext.getAndCast(name: String): T? =
    get(name, T::class.java)

internal inline fun <reified T : Any> ExecutionContext.getOrDefault(name: String, noinline defaultValue: () -> T): T =
