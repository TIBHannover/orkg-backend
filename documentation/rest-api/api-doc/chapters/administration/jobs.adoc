...
operation::jobs_get-status[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::jobs_get-results[snippets='path-parameters,curl-request,http-response']
...
operation::jobs_stop[snippets='path-parameters,curl-request,http-response']
