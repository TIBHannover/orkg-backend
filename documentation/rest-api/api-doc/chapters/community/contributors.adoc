...
operation::contributors_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::contributors_get-paged-with-parameters[snippets='query-parameters,curl-request']
