...
operation::observatory-filters_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::observatory-filters_get-paged[snippets='path-parameters,curl-request']
...
operation::observatory-filters_delete[snippets='path-parameters,curl-request,http-response']
