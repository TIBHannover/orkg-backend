...
operation::comparison-related-figures_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::comparison-related-figures_get-paged[snippets='path-parameters,curl-request']
