...
operation::comparison-related-resources_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::comparison-related-resources_get-paged[snippets='path-parameters,curl-request']
