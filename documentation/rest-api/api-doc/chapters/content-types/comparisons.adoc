...
operation::comparisons_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::comparisons_get-paged-with-parameters[snippets='query-parameters,curl-request']
