...
operation::contributions_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::contributions_get-paged[snippets='curl-request']
