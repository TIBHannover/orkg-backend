...
operation::datasets_fetch-dataset-summary[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::datasets_fetch-dataset-for-research-problem[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::datasets_fetch-research-problems-for-a-dataset[snippets='path-parameters,curl-request,http-response,response-fields']
