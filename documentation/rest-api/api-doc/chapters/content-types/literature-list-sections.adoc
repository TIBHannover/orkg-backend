...
operation::literature-lists_create-text-section-at-index[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
...
operation::literature-lists_update-text-section[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
...
operation::literature-lists_create-list-section-at-index[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
...
operation::literature-lists_update-list-section[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
