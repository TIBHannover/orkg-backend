...
operation::papers_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::papers_get-contributors[snippets='path-parameters,curl-request']
...
operation::papers_get-paged-with-parameters[snippets='query-parameters,curl-request']
