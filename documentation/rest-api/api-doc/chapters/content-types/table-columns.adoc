...
operation::tables_create-table-column-at-index[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
...
operation::tables_update-table-column[snippets='path-parameters,request-fields,curl-request,response-headers,http-response']
...
operation::tables_delete-table-column[snippets='path-parameters,curl-request,http-response']
