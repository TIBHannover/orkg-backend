...
operation::visualizations_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::visualizations_get-paged-with-parameters[snippets='query-parameters']
