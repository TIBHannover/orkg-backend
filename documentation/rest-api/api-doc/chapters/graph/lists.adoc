...
operation::lists_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::lists_get-elements[snippets='path-parameters,curl-request,http-response']
