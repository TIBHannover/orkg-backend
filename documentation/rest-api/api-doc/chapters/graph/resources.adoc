...
operation::resources_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::resources_get-paged-with-parameters[snippets='query-parameters,curl-request']
...
operation::resources_delete[snippets='path-parameters,curl-request,http-response']
