...
operation::rdf-vocab_resolve-resource_application-rdf-xml[snippets='path-parameters,curl-request,http-response,errors']
...
operation::rdf-vocab_resolve-predicate_text-n3[snippets='path-parameters,curl-request,http-response,errors']
...
operation::rdf-vocab_resolve-class_application-trig[snippets='path-parameters,curl-request,http-response,errors']
