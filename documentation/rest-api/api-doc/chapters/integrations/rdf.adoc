...
operation::rdf-vocab_resolve-resource[snippets='path-parameters,curl-request,http-response']
...
operation::rdf-vocab_resolve-predicate[snippets='path-parameters,curl-request,http-response']
...
operation::rdf-vocab_resolve-class[snippets='path-parameters,curl-request,http-response']
