...
operation::research-fields_get-problems-per-field[snippets='path-parameters,curl-request']
...
operation::research-fields_get-contributors-per-field[snippets='path-parameters,curl-request']
...
operation::research-fields_find-children[snippets='path-parameters,curl-request']
operation::research-fields_research-field-with-child-count[snippets='response-fields']
...
operation::research-fields_find-parents[snippets='path-parameters,curl-request']
...
operation::research-fields_find-roots[snippets='path-parameters,curl-request']
...
operation::research-fields_find-hierarchy[snippets='path-parameters,curl-request,http-response']
operation::research-fields_research-field-hierarchy-entry[snippets='response-fields']
