...
operation::research-problems_get-users-per-problem[snippets='path-parameters,query-parameters,curl-request,http-response,response-fields']
...
operation::research-problems_get-authors-per-problem[snippets='path-parameters,curl-request,http-response,response-fields']
