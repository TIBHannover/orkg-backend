...
operation::rosetta-stone-statements_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::rosetta-stone-statements_get-paged-with-parameters[snippets='query-parameters,curl-request']
...
operation::rosetta-stone-statements_get-all-versions[snippets='path-parameters,curl-request']
