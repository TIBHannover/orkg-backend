...
operation::rosetta-stone-templates_get-single[snippets='path-parameters,curl-request,http-response,response-fields']
...
operation::rosetta-stone-templates_get-paged-with-parameters[snippets='query-parameters']
