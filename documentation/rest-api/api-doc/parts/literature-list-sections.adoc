...
operation::literature-lists-create-text-section-at-index[snippets='curl-request,path-parameters,request-fields,http-response']
...
operation::literature-lists-create-list-section-at-index[snippets='curl-request,path-parameters,request-fields,http-response']
...
operation::literature-lists-delete-section[snippets='curl-request,path-parameters,http-response']
