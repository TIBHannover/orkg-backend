...
include::{snippets}/rdf-vocab-resolve-resource/curl-request.adoc[]
include::{snippets}/rdf-vocab-resolve-resource/http-response.adoc[]
...
include::{snippets}/rdf-vocab-resolve-predicate/curl-request.adoc[]
include::{snippets}/rdf-vocab-resolve-predicate/http-response.adoc[]
...
include::{snippets}/rdf-vocab-resolve-class/curl-request.adoc[]
include::{snippets}/rdf-vocab-resolve-class/http-response.adoc[]
