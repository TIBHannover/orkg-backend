...
operation::research-fields-get-paged[snippets='path-parameters,query-parameters,curl-request']
...
operation::stats-research-fields[snippets='query-parameters,curl-request,http-response,response-fields']
