...
operation::resources-get-single[snippets='curl-request,http-response,response-fields']
...
operation::resources-edit[snippets='request-fields,curl-request,http-response']
...
operation::resources-delete-resource-success[snippets='curl-request,http-response']
