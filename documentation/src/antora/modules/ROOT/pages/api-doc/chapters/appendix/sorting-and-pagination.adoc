...
[cols="1,3"]
include::{snippets}/paged_page/query-parameters.adoc[]

An example of a response of a paged list looks like this:

include::{snippets}/paged_page/response-body.adoc[]

include::{snippets}/paged_page/response-fields.adoc[]
...
2+^| *For sorting author records*
| author_id              | The id of the author
| author_name            | The name of the author
| paper_count	         | The count of papers attributed to
| comparison_count       | The count of comparisons attributed to
| visualization_count    | The count of visualizations attributed to
| total_count            | The total count of contributions attributed to
2+^| *For sorting contributor records*
| contributor_id         | The id of the contributor
| comparison_count       | The count of comparisons created
| paper_count	         | The count of papers created
| contribution_count     | The count of contributions created
| research_problem_count | The count of research problems created
| visualization_count    | The count of visualizations created
| total_count            | The total count of contributions created
|==============================================================================================
