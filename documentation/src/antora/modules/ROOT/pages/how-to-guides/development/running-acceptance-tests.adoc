...
This is achieved by using a special xref:reference/development/test-dsl.adoc[testing DSL].
...
The reason for this is Gradle not knowing about the container changing, because it is not part of the build, but <<building_the_image,done manually>>.
