...
private const val MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD_WITH_ID = """MATCH (node:Comparison:Resource)-[:RELATED]->(:Contribution:Resource)<-[:RELATED {predicate_id: "P31"}]-(:Paper:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource {resource_id: $id})"""
...
private const val MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD_WITH_ID = """MATCH (node:Problem:Resource)<-[:RELATED {predicate_id: 'P32'}]-(:Contribution:Resource)<-[:RELATED {predicate_id: 'P31'}]-(:Paper:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource {resource_id: $id})"""
...
private const val MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD_WITH_ID = """MATCH (node:Visualization:Resource)<-[:RELATED {predicate_id: 'hasVisualization'}]-(:Comparison:Resource)-[:RELATED {predicate_id: 'hasSubject'}]->(:ResearchField:Resource {resource_id: $id})"""
...
private const val MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD_WITH_ID = """MATCH (node:SmartReviewPublished:Resource)-[:RELATED]->(:SmartReview:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource {resource_id: $id})"""
...
private const val MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD_WITH_ID = """MATCH (node:LiteratureListPublished:Resource)-[:RELATED]->(:LiteratureList:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource {resource_id: $id})"""
...
interface Neo4jResearchFieldRepository :
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_PAPER_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_PAPER_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY_IS_LISTED $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_RESEARCH_FIELD_WITH_SUBFIELDS $MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD $WHERE_VISIBILITY $AND_FIELD_IN_FIELDS $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD_WITH_ID $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE""",
