...
interface Neo4jResearchFieldRepository :
    ...
    @Query("MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: $id}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(p:Paper)-[:RELATED{predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields AND $IS_UNLISTED_P WITH DISTINCT p, p.created_at AS created_at, p.resource_id AS resource_id, p.label AS label, p.created_by AS created_by RETURN p",
        countQuery = "MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: $id}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(p:Paper)-[:RELATED{predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields AND $IS_UNLISTED_P RETURN COUNT(p) AS cnt")
    ...
    @Query("MATCH(paper:Paper)-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:$id}) WHERE $IS_FEATURED_PAPER AND $IS_UNLISTED_PAPER WITH DISTINCT paper, paper.created_at AS created_at, paper.resource_id AS resource_id, paper.label AS label, paper.created_by AS created_by RETURN paper",
        countQuery = "MATCH(paper:Paper)-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:$id}) WHERE $IS_FEATURED_PAPER AND $IS_UNLISTED_PAPER RETURN COUNT(paper) AS cnt")
    ...
    @Query("MATCH(paper:Paper)-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:$id}) WHERE $IS_UNLISTED_PAPER WITH DISTINCT paper, paper.created_at AS created_at, paper.resource_id AS resource_id, paper.label AS label, paper.created_by AS created_by RETURN paper",
        countQuery = "MATCH(paper:Paper)-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:$id}) WHERE $IS_UNLISTED_PAPER RETURN COUNT(paper) AS cnt")
    ...
    @Query(value = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: $id}) WHERE $IS_FEATURED_COMPARISON AND $IS_UNLISTED_COMPARISON WITH DISTINCT comparison, comparison.resource_id AS resource_id, comparison.label AS label, comparison.created_by AS created_by, comparison.created_at AS created_at RETURN comparison",
        countQuery = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: $id}) WHERE $IS_FEATURED_COMPARISON AND $IS_UNLISTED_COMPARISON RETURN COUNT(comparison)")
    ...
    @Query(value = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: $id}) WHERE $IS_UNLISTED_COMPARISON WITH DISTINCT comparison, comparison.resource_id AS resource_id, comparison.label AS label, comparison.created_by AS created_by, comparison.created_at AS created_at RETURN comparison",
        countQuery = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: $id}) WHERE $IS_UNLISTED_COMPARISON RETURN COUNT(comparison)")
    ...
    @Query("""MATCH (field:ResearchField {resource_id: $id})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE $IS_FEATURED_PROBLEM AND $IS_UNLISTED_PROBLEM WITH DISTINCT problem, problem.created_at AS created_at, problem.resource_id AS resource_id, problem.created_by AS created_by RETURN problem """,
        countQuery = """MATCH (field:ResearchField {resource_id: $id})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE $IS_FEATURED_PROBLEM AND $IS_UNLISTED_PROBLEM RETURN COUNT(DISTINCT problem) AS cnt""")
    ...
    @Query("""MATCH (field:ResearchField {resource_id: $id})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE $IS_UNLISTED_PROBLEM WITH DISTINCT problem, problem.created_at AS created_at, problem.resource_id AS resource_id, problem.created_by AS created_by RETURN problem """,
        countQuery = """MATCH (field:ResearchField {resource_id: $id})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE $IS_UNLISTED_PROBLEM RETURN COUNT(DISTINCT problem) AS cnt""")
    ...
    @Query("""MATCH (v:Visualization)<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: $id}) WHERE $IS_FEATURED_V AND $IS_UNLISTED_V WITH DISTINCT v, v.resource_id AS resource_id, v.label AS label, v.created_by AS created_by, v.created_at AS created_at RETURN v""",
        countQuery = """MATCH (v:Visualization)<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: $id}) WHERE $IS_FEATURED_V AND $IS_UNLISTED_V RETURN COUNT(DISTINCT v) AS cnt""")
    ...
    @Query("""MATCH (v:Visualization)<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: $id}) WHERE $IS_UNLISTED_V WITH DISTINCT v, v.resource_id AS resource_id, v.label AS label, v.created_by AS created_by, v.created_at AS created_at RETURN v""",
        countQuery = """MATCH (v:Visualization)<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: $id}) WHERE $IS_UNLISTED_V RETURN COUNT(DISTINCT v) AS cnt""")
    ...
    @Query("""MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) AND $IS_FEATURED_R AND $IS_UNLISTED_R WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) AND $IS_FEATURED_R AND $IS_UNLISTED_R RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) AND $IS_UNLISTED_R WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) AND $IS_UNLISTED_R RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) AND $IS_FEATURED_R AND $IS_UNLISTED_R WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) AND $IS_FEATURED_R AND $IS_UNLISTED_R RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) AND $IS_UNLISTED_R WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource)-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: $id}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) AND $IS_UNLISTED_R RETURN COUNT(DISTINCT r) AS cnt""")
