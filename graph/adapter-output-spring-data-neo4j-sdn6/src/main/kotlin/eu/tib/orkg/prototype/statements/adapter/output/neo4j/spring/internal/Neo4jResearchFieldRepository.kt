...
interface Neo4jResearchFieldRepository :
    ...
    @Query("MATCH(paper:Paper {unlisted: $unlisted} )-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:$id}) WITH DISTINCT paper, paper.created_at AS created_at, paper.resource_id AS resource_id, paper.label AS label, paper.created_by AS created_by RETURN paper $PAGE_PARAMS",
