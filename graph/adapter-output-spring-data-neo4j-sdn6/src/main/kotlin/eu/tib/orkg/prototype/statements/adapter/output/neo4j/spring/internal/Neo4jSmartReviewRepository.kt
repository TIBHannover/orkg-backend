...
interface Neo4jSmartReviewRepository :
    ...
    @Query(
        value = """$MATCH_FEATURED_SMART_REVIEW $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query(
        value = """$MATCH_NONFEATURED_SMART_REVIEW $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query(
        value = """$MATCH_UNLISTED_SMART_REVIEW $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
    ...
    @Query(
        value = """$MATCH_LISTED_SMART_REVIEW $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
