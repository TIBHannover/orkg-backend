...
fun resourceResponseFields(): List<FieldDescriptor> = listOf(
    ...
    fieldWithPath("classes[]").description("The set of classes of which this resource is an instance of."),
    fieldWithPath("uri").type("String").description("An optional URI to describe the resource (RDF).").optional(),
