...
private const val INCLUDING_SUBFIELDS = """<-[:RELATED* 0.. {predicate_id: 'P36'}]-(:ResearchField:Resource {id: $id})"""
...
private const val MATCH_PAPER_RELATED_TO_RESEARCH_FIELD = """MATCH (node:Paper:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource)"""
...
private const val MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD = """MATCH (node:Comparison:Resource)-[:RELATED]->(:Contribution:Resource)<-[:RELATED {predicate_id: "P31"}]-(:Paper:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource)"""
...
private const val MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD = """MATCH (node:Problem:Resource)<-[:RELATED {predicate_id: 'P32'}]-(:Contribution:Resource)<-[:RELATED {predicate_id: 'P31'}]-(:Paper:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource)"""
...
private const val MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD = """MATCH (node:Visualization:Resource)<-[:RELATED {predicate_id: 'hasVisualization'}]-(:Comparison:Resource)-[:RELATED {predicate_id: 'hasSubject'}]->(:ResearchField:Resource)"""
...
private const val MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD = """MATCH (node:SmartReviewPublished:Resource)-[:RELATED]->(:SmartReview:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource)"""
...
private const val MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD = """MATCH (node:LiteratureListPublished:Resource)-[:RELATED]->(:LiteratureList:Resource)-[:RELATED {predicate_id: 'P30'}]->(:ResearchField:Resource)"""
...
interface Neo4jResearchFieldRepository :
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_PAPER_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_COMPARISON_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_PROBLEM_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_VISUALIZATION_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_SMART_REVIEW_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY_IS_LISTED $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
    ...
    @Query("""$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE $PAGE_PARAMS""",
        countQuery = """$MATCH_LITERATURE_LIST_RELATED_TO_RESEARCH_FIELD$INCLUDING_SUBFIELDS $WHERE_VISIBILITY $WITH_DISTINCT_NODE $WITH_NODE_PROPERTIES $RETURN_NODE_COUNT""")
