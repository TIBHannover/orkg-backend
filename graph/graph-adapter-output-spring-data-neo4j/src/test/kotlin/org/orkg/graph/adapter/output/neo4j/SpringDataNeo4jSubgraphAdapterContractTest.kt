...
import org.orkg.graph.testing.fixtures.subgraphRepositoryContract
import org.orkg.testing.annotations.Neo4jContainerUnitTest

@Neo4jContainerUnitTest(
    classes = [
        SpringDataNeo4jSubgraphAdapter::class,
...
internal class SpringDataNeo4jSubgraphAdapterContractTest(
    private val springDataNeo4jSubgraphAdapter: SubgraphRepository,
    ...
    private val springDataNeo4jPredicateAdapter: PredicateRepository,
        ...
        include(
            subgraphRepositoryContract(
                springDataNeo4jSubgraphAdapter,
