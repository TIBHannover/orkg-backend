...
object Predicates {
    ...
    val exclusionCriteria = ThingId("P175068")
    ...
    val inclusionCriteria = ThingId("P174086")
    val isAnonymized = ThingId("IsAnonymized")
    val mentions = ThingId("mentions")
    val monthPublished = ThingId("P28")
    val numberOfStudiesOriginallyReturned = ThingId("numberOfStudiesOriginallyReturned")
    val numberOfStudiesRetained = ThingId("numberOfStudiesRetained")
    val placeholder = ThingId("placeholder")
    val reference = ThingId("reference")
    val researchQuestions = ThingId("researchQuestions")
    val sameAs = ThingId("SAME_AS")
    val searchEngines = ThingId("searchEngines")
    val searchStrings = ThingId("searchStrings")
...
object Classes {
    ...
    val relatedWorkComparison = ThingId("RelatedWorkComparison")
    val researchField = ThingId("ResearchField")
    val resource = ThingId("Resource")
    val resourceComparison = ThingId("ResourceComparison")
    ...
    val stateOfTheArtComparison = ThingId("StateOfTheArtComparison")
    val string = ThingId("String")
    val supplementaryInformationDescription = ThingId("SupplementaryInformationDescription")
    val sustainableDevelopmentGoal = ThingId("SustainableDevelopmentGoal")
    val systematicComparison = ThingId("SystematicComparison")
