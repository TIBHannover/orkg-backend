    ...
    suites {
        ...
        val integrationTest by registering(JvmTestSuite::class) {
            dependencies {
                ...
                compileOnly("com.github.multiformats:java-multihash")
                compileOnly("org.springframework:spring-context")
                compileOnly("tools.jackson.core:jackson-databind")
                compileOnly(project(":common:core-identifiers"))
                compileOnly(project(":community:community-core-model"))
                compileOnly(project(":community:community-ports-input"))
                compileOnly(project(":graph:graph-core-model"))
                compileOnly(project(":graph:graph-ports-input"))
                compileOnly(project(":media-storage:media-storage-core-model"))
                ...
                implementation(project(":data-import:data-import-adapter-input-rest-spring-mvc"))
                implementation(project(":data-import:data-import-core-model"))
                implementation(project(":data-import:data-import-core-services")) // for job configurations
                ...
                runtimeOnly("io.kotest:kotest-assertions-core")
                runtimeOnly("io.kotest:kotest-extensions-spring")
                runtimeOnly("io.kotest:kotest-extensions-testcontainers")
                runtimeOnly("io.kotest:kotest-framework-engine")
                runtimeOnly("io.kotest:kotest-property")
                ...
                runtimeOnly("org.testcontainers:testcontainers-junit-jupiter")
                runtimeOnly("org.testcontainers:testcontainers-neo4j")
                runtimeOnly("org.testcontainers:testcontainers-postgresql")
                runtimeOnly("tools.jackson.core:jackson-databind")
                runtimeOnly(project(":common:core-identifiers"))
                runtimeOnly(project(":community:community-core-model"))
                runtimeOnly(project(":community:community-ports-input"))
                runtimeOnly(project(":graph:graph-core-model"))
                runtimeOnly(project(":graph:graph-ports-input"))
...
tasks {
    ...
    val integrationTest: Test by getting(Test::class) {
        doFirst {
