...
operation::statement-controller-integration-test-index[snippets='request-parameters,curl-request,http-response']
...
operation::statement-controller-integration-test-delete-literal-statement[snippets='curl-request,http-response']
...
operation::statement-controller-integration-test-lookup-by-subject[snippets='request-parameters,curl-request,http-response']
...
operation::statement-controller-integration-test-lookup-by-predicate[snippets='request-parameters,curl-request,http-response']
...
operation::resource-controller-integration-test-edit[snippets='curl-request,http-response']
...
operation::literal-controller-integration-test-index[snippets='curl-request,http-response']
...
operation::literal-controller-integration-test-fetch[snippets='curl-request,http-response']
