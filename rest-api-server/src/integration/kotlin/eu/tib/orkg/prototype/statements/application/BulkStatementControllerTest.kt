...
class BulkStatementControllerTest : RestDocumentationBaseTest() {
    ...
    private fun bulkStatementListEditResponseFields() =
        responseFields(
            ...
            fieldWithPath("[].statement.subject.featured").description("The featured value").optional(),
            ...
            fieldWithPath("[].statement.predicate.featured").description("The featured value of the predicate").optional(),
            ...
            fieldWithPath("[].statement.object.featured").description("The featured value").optional()
        )
    ...
    private fun bulkStatementListResponseFields() =
        responseFields(
            ...
            fieldWithPath("[].statements.[].subject.featured").description("The featured value").optional(),
            ...
            fieldWithPath("[].statements.[].predicate.featured").description("The featured value.").optional(),
            ...
            fieldWithPath("[].statements.[].object.featured").optional()
        )
}
