...
class ResourceControllerTest(neo4jClient: Neo4jClient) : RestDocumentationBaseTest(neo4jClient) {
    ...
    companion object RestDoc {
        fun resourceResponseFields() = listOf(
            ...
            fieldWithPath("verified").description("Indicator if the resource was manually verified curator").optional(),
