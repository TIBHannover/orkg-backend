...
@IntegrationTest
internal class SubgraphControllerIntegrationTest : MockMvcBaseTest("subgraphs") {
    @Autowired
    ...
    fun findByRootId() {
        ...
        val result = get("/api/things/{id}/subgraph", a)
            .perform()
            ...
            .response
            .contentAsString
            .let { objectMapper.readValue<PageRepresentation<GeneralStatement>>(it) }
