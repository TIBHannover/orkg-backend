...
interface Neo4jResearchFieldRepository :
    ...
    @Query("MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(p:Paper {unlisted:{1}})-[:RELATED{predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields WITH DISTINCT p, p.created_at AS created_at, p.resource_id AS resource_id, p.label AS label, p.created_by AS created_by RETURN p",
        countQuery = "MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(p:Paper {unlisted:{1}})-[:RELATED{predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields RETURN COUNT(p) AS cnt")
    ...
    @Query("""MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(orkgcomparisons: Comparison {unlisted: {1}} )-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: "P31"}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields WITH DISTINCT orkgcomparisons, orkgcomparisons.resource_id AS resource_id, orkgcomparisons.label AS label, orkgcomparisons.created_by AS created_by, orkgcomparisons.created_at AS created_at RETURN orkgcomparisons""",
        countQuery = """MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH(orkgcomparisons: Comparison {unlisted: {1}} )-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: "P31"}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields RETURN COUNT(DISTINCT orkgcomparisons) AS cnt""")
    ...
    @Query("""MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (orkgproblems:Thing {unlisted: {1}})<-[:RELATED {predicate_id: 'P32'}]-(contr1: Contribution)<-[:RELATED{predicate_id: 'P31'}]-(papers1:Paper)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields WITH DISTINCT orkgproblems, orkgproblems.resource_id AS resource_id, orkgproblems.created_at AS created_at, orkgproblems.label AS label, orkgproblems.created_by AS created_by RETURN orkgproblems""",
        countQuery = """MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (orkgproblems:Thing {unlisted: {1}})<-[:RELATED {predicate_id: 'P32'}]-(contr1: Contribution)<-[:RELATED{predicate_id: 'P31'}]-(papers1:Paper)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields RETURN COUNT(DISTINCT orkgproblems)""")
    ...
    @Query("MATCH(paper:Paper {unlisted: {1}} )-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:{0}}) WITH DISTINCT paper, paper.created_at AS created_at, paper.resource_id AS resource_id, paper.label AS label, paper.created_by AS created_by RETURN paper",
        countQuery = "MATCH(paper:Paper {unlisted: {1}})-[:RELATED {predicate_id: 'P30'}]->(r: ResearchField{resource_id:{0}}) RETURN COUNT(paper) AS cnt")
    fun getPapersExcludingSubFieldsWithoutFeaturedFlag(id: ResourceId, unlisted: Boolean, pageable: Pageable): Page<Neo4jResource>

    @Query(value = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: {0}}) WHERE (comparison.featured=true OR comparison.featured = false OR comparison.unlisted = false) WITH DISTINCT comparison, comparison.resource_id AS resource_id, comparison.label AS label, comparison.created_by AS created_by, comparison.created_at AS created_at RETURN comparison",
        countQuery = "MATCH(comparison: Comparison)-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: {0}}) WHERE (comparison.featured=true OR comparison.featured = false OR comparison.unlisted = false) RETURN COUNT(comparison)")
    ...
    @Query(value = "MATCH(comparison: Comparison {unlisted: {1}})-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: {0}}) WITH DISTINCT comparison, comparison.resource_id AS resource_id, comparison.label AS label, comparison.created_by AS created_by, comparison.created_at AS created_at RETURN comparison",
        countQuery = "MATCH(comparison: Comparison {unlisted: {1}})-[related:RELATED]->(contr:Contribution)<-[:RELATED{predicate_id: 'P31'}]-(p:Paper)-[:RELATED {predicate_id: 'P30'}]->(r:ResearchField{resource_id: {0}}) RETURN COUNT(comparison)")
    ...
    @Query("""MATCH (field:ResearchField {resource_id: {0}})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE (problem.featured=true OR problem.featured = false OR problem.unlisted = false) WITH DISTINCT problem, problem.created_at AS created_at, problem.resource_id AS resource_id, problem.created_by AS created_by RETURN problem """,
        countQuery = """MATCH (field:ResearchField {resource_id: {0}})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing) WHERE (problem.featured=true OR problem.featured = false OR problem.unlisted = false) RETURN COUNT(DISTINCT problem) AS cnt""")
    ...
    @Query("""MATCH (field:ResearchField {resource_id: {0}})<-[:RELATED {predicate_id: 'P30'}]-(paper:Paper)-[:RELATED {predicate_id: 'P31'}]->(cont:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Thing {unlisted: {1}} ) WITH DISTINCT problem, problem.created_at AS created_at, problem.resource_id AS resource_id, problem.created_by AS created_by RETURN problem """,
    ...
    @Query("""MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (v:Visualization {unlisted: {1}})<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(resField) WHERE resField IN all_research_fields WITH DISTINCT v, v.resource_id AS resource_id, v.label AS label, v.created_by AS created_by, v.created_at AS created_at RETURN v""",
        countQuery = """MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (v:Visualization {unlisted: {1}})<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(resField) WHERE resField IN all_research_fields RETURN COUNT(DISTINCT v) AS cnt""")
    ...
    @Query("""MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields AND 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (research:ResearchField)<-[:RELATED* 0.. {predicate_id: 'P36'}]-(research1:ResearchField{resource_id: {0}}) WITH COLLECT (research) + COLLECT(research1) AS all_research_fields MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(resField) WHERE resField IN all_research_fields AND 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (v:Visualization {unlisted: {1}})<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: {0}}) WITH DISTINCT v, v.resource_id AS resource_id, v.label AS label, v.created_by AS created_by, v.created_at AS created_at RETURN v""",
        countQuery = """MATCH (v:Visualization {unlisted: {1}})<-[:RELATED {predicate_id: 'hasVisualization'}]-(comparison1: Comparison)-[related:RELATED {predicate_id: 'hasSubject'}]->(r: ResearchField {resource_id: {0}}) RETURN COUNT(DISTINCT v) AS cnt""")
    ...
    @Query("""MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE  'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE 'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE  'SmartReviewPublished' IN LABELS(r) AND 'SmartReview' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE  'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
    ...
    @Query("""MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource {unlisted: {1}})-[:RELATED]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE  'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
