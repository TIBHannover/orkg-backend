...
interface Neo4jResearchFieldRepository :
    ...
    @Query("""MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:HasPaper]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE 'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) WITH DISTINCT r, r.resource_id AS resource_id, r.label AS label, r.created_by AS created_by, r.created_at AS created_at RETURN r""",
        countQuery = """MATCH (r:Resource {featured: {1}, unlisted: {2}})-[:HasPaper]->(r1: Resource)-[:RELATED {predicate_id: 'P30'}]->(research: ResearchField {resource_id: {0}}) WHERE  'LiteratureListPublished' IN LABELS(r) AND 'LiteratureList' IN LABELS(r1) RETURN COUNT(DISTINCT r) AS cnt""")
