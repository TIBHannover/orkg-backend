...
TIP: This is a paginated, and sortable call, check the table below for allowed keys for sorting <<sorting-and-pagination>>
...
Note: This is a paginated, and sortable call, check the table below for allowed keys for sorting <<sorting-and-pagination>>
...
operation::resource-controller-test-delete-resource-success[snippets='request-parameters,curl-request,http-response']

If the resource doesn't exist, the API returns a 404 status code.

operation::resource-controller-test-delete-resource-not-found[snippets='request-parameters,curl-request,http-response']
...
operation::resource-controller-test-delete-resource-forbidden[snippets='request-parameters,curl-request,http-response']
