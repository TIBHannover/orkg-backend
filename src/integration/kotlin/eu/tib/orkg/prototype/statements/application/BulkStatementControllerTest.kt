...
class BulkStatementControllerTest : RestDocumentationBaseTest() {
    ...
    private fun bulkStatementListEditResponseFields() =
        responseFields(
            ...
            fieldWithPath("[].statement.predicate.description").description("The description of the predicate (Optional)."),
    ...
    private fun bulkStatementListResponseFields() =
        responseFields(
            ...
            fieldWithPath("[].statements.[].predicate.description").description("The description of the predicate (Optional)."),
