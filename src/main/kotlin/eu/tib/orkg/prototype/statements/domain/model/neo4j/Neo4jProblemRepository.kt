...
interface Neo4jProblemRepository :
    ...
    @Query(value = """MATCH (ds:Dataset {resource_id: 'R121347'})<-[:RELATED {predicate_id: 'HAS_DATASET'}]-(:Benchmark)<-[:RELATED {predicate_id: 'HAS_BENCHMARK'}]-(:Contribution)-[:RELATED {predicate_id: 'P32'}]->(problem:Problem)
